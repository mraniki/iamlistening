...
#     settings.configure(FORCE_ENV_FOR_DYNACONF="testinglemmy")


# @pytest.mark.asyncio
# async def test_fixture():
#     assert settings.VALUE == "On Testing Lemmy"
...
#     assert listener.platform == "lemmy"
